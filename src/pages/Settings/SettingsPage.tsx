...
const parameterGroups = [
  ...
  {
    title: "Parâmetros de Compra/Venda",
    description: "Configurações relacionadas à compra e venda do imóvel",
    parameters: [
      "param_tempo_venda",
...
const parameterDescriptions = {
  margem_area_pct: {
    ...
    description:
      "Este percentual define a variação permitida na área do imóvel ao buscar propriedades comparáveis. Por exemplo: Se escolher 10% e o imóvel tem 100m², serão considerados imóveis de 90m² a 110m².",
    unit: "%",
  },
  reducao_pct: {
    label: "Redução no Preço de Referência",
    description:
      "Percentual de redução aplicado ao preço médio das propriedades de referência para calcular o valor sugerido de venda. Por exemplo: Se os imóveis similares têm média de R$ 1.000.000 e esse percentual for 8%, o preço sugerido será R$ 920.000.",
    unit: "%",
  },
  param_entrada_pct: {
    label: "Percentual de Entrada",
    description:
      "Percentual do valor do imóvel exigido como entrada no financiamento. Atualmente, os bancos praticam entre 20% e 30%.",
    unit: "%",
  },
  param_itbi_pct: {
    label: "ITBI",
    description:
      "Imposto sobre Transmissão de Bens Imóveis, cobrado na transferência do imóvel.",
    unit: "%",
  },
  param_avaliacao_bancaria: {
    label: "Avaliação Bancária",
    description:
      "Custo cobrado pelo banco para realizar a avaliação do imóvel no processo de financiamento.",
    unit: "R$",
  },
  param_registro_cartorio_pct: {
  ...
  param_custo_reforma_pct: {
    ...
    description:
      "Estimativa do custo de reforma como percentual do valor do imóvel.",
    unit: "%",
  },
  param_taxa_cet: {
    label: "Taxa CET",
    description:
      "Custo Efetivo Total da operação, que representa a taxa de juros total aplicada pelo banco no financiamento.",
    unit: "% a.a.",
  },
  param_prazo_financiamento: {
    label: "Prazo de Financiamento",
    description:
      "Duração total do financiamento imobiliário em meses. O padrão é 420 meses (35 anos).",
    unit: "meses",
  },
  param_tempo_venda: {
    label: "Tempo Estimado de Venda",
    description:
      "Estimativa do tempo necessário para vender o imóvel após a conclusão da reforma.",
    unit: "meses",
  },
  param_corretagem_venda_pct: {
    label: "Corretagem de Venda",
    description:
      "Percentual cobrado pelo corretor para intermediar a venda do imóvel.",
    unit: "%",
  },
  param_desconto_valor_compra: {
    label: "Desconto na Compra",
    description:
      "Desconto estimado a ser negociado no valor de compra do imóvel. Recomenda-se entre 5% e 8%.",
    unit: "%",
  },
};
