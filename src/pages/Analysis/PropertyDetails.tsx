    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <div className="space-y-4">
        {parameters.map((param) => (
          <div key={param.param} className="border-b border-gray-200 pb-4">
            ...
            <div className="flex items-center">
              ...
              <input
                ...
                className="w-full border-0 border-b-2 border-gray-300 focus:ring-0 focus:border-blue-500 text-lg"
              />
              {param.suffix && (
